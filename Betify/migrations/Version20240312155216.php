 ...
 */
final class Version20240312155216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE canciones (idCancion INT AUTO_INCREMENT NOT NULL, Nombre VARCHAR(45) DEFAULT \'NULL\', Reproducciones INT NOT NULL, Puesto INT NOT NULL, UNIQUE INDEX idCancion_UNIQUE (idCancion), PRIMARY KEY(idCancion)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
