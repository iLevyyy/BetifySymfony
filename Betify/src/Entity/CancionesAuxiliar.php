 ...
 * CancionesAuxiliar
 *
 * @ORM\Table(name="cancionesauxiliar", uniqueConstraints={@ORM\UniqueConstraint(name="idCancion_UNIQUE", columns={"idCancion"})})
 * @ORM\Entity
 */
class CancionesAuxiliar
{
    /**
     * @var int
     *
    ...
    public function setReproducciones(int $reproducciones): void
    {
