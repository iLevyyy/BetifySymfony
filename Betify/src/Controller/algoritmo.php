...
$pendientePonderadaCancion1 = pendiente($cancion1vd2,$cancion1vd3)*0.7 + pendiente($cancion1vd1,$cancion1vd2)*0.8 +pendiente($cancion1vd0,$cancion1vd1)*0.9;
$pendientePonderadaCancion2 = pendiente($cancion2vd2,$cancion2vd3)*0.7 + pendiente($cancion2vd1,$cancion2vd2)*0.8 +pendiente($cancion2vd0,$cancion2vd1)*0.9;
...
// $relacionCrecimientoEntreCanciones = $relacionCrecimientoTotalCancion1/$relacionCrecimientoTotalCancion2;
...
// echo("Tasa de crecimiento entre canciones (la cancion A ha crecido sobre la B: ".$relacionCrecimientoEntreCanciones);
...
// $cuota =  $diferenciaVisitasDia0 * $relacionCrecimientoEntreCanciones;
